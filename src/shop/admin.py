...
class GoodsAdmin(admin.ModelAdmin):
    ...
    def make_published(self, request, queryset):
        ...
        if status == 1:
            ...
            self.message_user(
                request, "{} {}".format(status, _("few_products_success"))
            )
    ...
    def un_published(self, request, queryset):
        ...
        if status == 1:
            ...
            self.message_user(
                request, "{} {}".format(status, _("un_few_products_success"))
            )
...
class CategoryAdmin(admin.ModelAdmin):
    ...
    def make_published(self, request, queryset):
        ...
        if status == 1:
            ...
            self.message_user(
                request, "{} {}".format(status, _("few_categories_success"))
            )
    ...
    def un_published(self, request, queryset):
        ...
        if status == 1:
            ...
            self.message_user(
                request, "{} {}".format(status, _("un_few_categories_success"))
            )
